...
NUM_CLASSES = 5
IMAGE_SIZE = 224
EPOCHS = 1  # Standard imagenet training regime.
APPROX_IMAGENET_TRAINING_IMAGES = 2934  # Approximate number of images.
IMAGENET_VALIDATION_IMAGES = 364  # Number of images.
